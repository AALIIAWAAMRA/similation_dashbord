function simulationApp() {
   return {
      topics: [
         { name: "Networek Attack", tool: "Python", category: "Engineering", reserved: true, reservedBy: "NIDHAL, SAMADOU, BADRO" },
         { name: "Financial Market Modeling", tool: "Python", category: "Business", reserved: true, reservedBy: "HAMZA, RAOUF" },
         { name: "Hospital Patient Flow Optimization", tool: "AnyLogic", category: "Healthcare", reserved: true, reservedBy: "HIBA, BESMALA, HADHER, SELMA" },
         { name: "Supply Chain Network Analysis", tool: "Python", category: "Business", reserved: true, reservedBy: "MERIEM, AYA, CHAIMA, DOUAA" },
         { name: "Structural Analysis of Bridges", tool: "SimScale", category: "Engineering", reserved: true, reservedBy: "HADJER, RIDA" },
         { name: "Urban Traffic Flow Simulation", tool: "MATLAB", category: "Engineering", reserved: true, reservedBy: "WISSAK, ARIDJ" },
         { name: "Weather Prediction Models", tool: "Python", category: "Physics", reserved: true, reservedBy: "BESSMALA, NOUR, AYA" },
         { name: "Virtual Reality Surgical Training", tool: "Unity", category: "Healthcare", reserved: true, reservedBy: "ALIM, MOHAMED, YOUNES" },
         { name: "Social Network Influence Model", tool: "NetLogo", category: "Social", reserved: true, reservedBy: "FATHI, AKRAM, SELIMAN, AMINE" },
         { name: "Earthquake Impact Simulation", tool: "MATLAB", category: "Physics", reserved: false, reservedBy: null },
         { name: "Manufacturing Process Optimization", tool: "AnyLogic", category: "Engineering", reserved: false, reservedBy: null },
         { name: "Population Growth Models", tool: "Python", category: "Social", reserved: false, reservedBy: null },
